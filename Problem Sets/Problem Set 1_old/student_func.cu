		...
		int numRows, int numCols)
{
	...
	if (realid < numRows*numCols){
		...
		//printf("R is %d, G is %d, B is %d, at %d, %d\n",rgba.x,rgba.y,rgba.z,thid_x,thid_y);
		float channelSum = .299f * rgba.x + .587f * rgba.y + .114f * rgba.z;
		//printf("GPU says %f, at %d, %d\n",channelSum,thid_x,thid_y);
		...
		unsigned char* const d_greyImage, size_t numRows, size_t numCols)
{
	...
	//const dim3 gridSize(numCols/block_x, numRows/block_y, 1);  //TODO
